...
{
    public interface IStateMachineHistorySimplified
    {
    ...
    public class StateMachineSimplified
    {
        private IState CurrentState { get; set; }

        public Action<StateMachineSimplified, IState, IState> OnStateChanged;
    ...
    public class StateMachineHistorySimplified : IStateMachineHistorySimplified
    {
    ...
    public class StateMachineHistorySimplified<TStateMachine, TState> : StateMachineHistorySimplified
        ...
        where TState : StateHistorySimplified<TStateMachine, TState>
    {
        ...
        {
            TState state = StateHistorySimplified.Get<TState>(stateType);
